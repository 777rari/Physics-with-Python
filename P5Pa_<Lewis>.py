...
# on this program.
# Description: Use vectors and vpython to calculate Force of Gravity of three orange masses on one yellow mass that are on a line on the x axis.
# Input: None
...
print(F_2on0)
print(F_3on0)
print("Total Force", Total_Force, Total_Force.x, "Newtons in  negative x direction")
