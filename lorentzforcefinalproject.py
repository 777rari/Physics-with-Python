...
# -*- coding: utf-8 -*-
"""
Created on Wed May  8 00:39:50 2024
...
elctric_charge= sphere(radius=0.08, color=color.red,
                       pos=vector(-6, 0, -2), make_trail=True)

electric_charge.q = 0.1
electric_charge.mass = 0.06
elctric_charge.velocity = vector(6, 0, 0)
...
while 1:
    rate(50)
    electric_charge.pos += elctric_charge.velocity * dt
